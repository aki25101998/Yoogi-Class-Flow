...
export default async function InvitePage({ params }: { params: { invitationId: string } }) {
  ...
  if (error || !invitation) {
    return (
      <div className="flex w-full h-screen items-center justify-center bg-background p-4">
      ...
      <div className="w-full" style={{ maxWidth: '448px' }}>
        <Card className="text-center">
          <CardContent className="p-8">
            <div className="w-16 h-16 bg-primary/10 text-primary rounded-full flex items-center justify-center mx-auto mb-6" style={{ borderRadius: '50%', backgroundColor: 'var(--primary-light)', color: 'var(--primary)', width: '64px', height: '64px' }}>
            ...
            <div className="mb-8 text-left" style={{ backgroundColor: 'var(--surface-hover)', padding: 'var(--space-4)', borderRadius: 'var(--radius-md)' }}>
              <div className="mb-2">
