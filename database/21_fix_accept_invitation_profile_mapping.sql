-- Migration: Fix accept invitation profile mapping and race conditions
-- This ensures the invitation process is atomic and correctly maps profiles.id to organization_members.user_id
